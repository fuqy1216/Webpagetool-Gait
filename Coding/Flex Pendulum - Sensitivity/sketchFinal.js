...
function setup() {
 ...
 //LoadB.attribute('disabled', '');
  ...
  Optimize = createCheckbox('Search Feasible Gait (Enumeration, debugging)', true);
  Optimize.position(loopC.x + 170, loopC.y);
  Optimizestep = createCheckbox('Search Feasible Gait (Gradient-based Search)', false);
...
{ 
  var Refervec = [];
  /*
  for(theta0_4 = 0; theta0_4>-30; theta0_4 = theta0_4 - 5)
  {
