...
void newDraw() {
    ...
    postCoords();
    if (abs(rightAnkleX - leftAnkleX) > strideLength) strideLength = abs(rightAnkleX - leftAnkleX);
    document.getElementById("strideLength").innerHTML = "Stride Length: " + strideLength*2 + " mm";
}
